...
class RespostaModel extends CI_model {
    public function cadastrar_resposta($respostaData){
        ...
        if (isset($_SESSION['logado'])) {
            ...
            $resposta = array_map('strip_tags', $respostaData);
            $resposta = array_map('stripcslashes', $resposta);
            if (isset($resposta['tipo_pericia']) && isset($resposta['resposta'])) {
                // Inserindo a resposta na tabela principal e obtendo o ID gerado
                $respostaHead = array(
                    'resposta' => $resposta['resposta'],
                    'tipo_pericia' => $resposta['tipo_pericia']
                );
                if ($this->db->insert('resposta', $respostaHead)) {
