  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php if(isset($dados['dados_cargo']['cargo'])){echo $dados['dados_cargo']['cargo'][0]->TITULO_CARGO;} ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./">{titulo}</a></li>
              <li class="breadcrumb-item active"><?php if(isset($dados['dados_cargo']['cargo'])){echo $dados['dados_cargo']['cargo'][0]->TITULO_CARGO;} ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
			<?php
			if (isset($dados['dados_cargo']['cargo'])){
				echo $dados['dados_cargo']['cargo'][0]->DESCRICAO_CARGO . '<br>';
				// LISTA COLABORADORES
				?>
				<hr>
				<div id="accordion">
					...
					foreach ($dados['usuarios']['usuario'] as $index => $usuario) {
						...
						<div class="card">
							...
							<div id="item<?= $index+1 ?>" class="collapse" aria-labelledby="headingOne"
								...
								<div class="card-body">
									<b>Departamento:</b> <?= $dados['departamentos']['departamentos'][$usuario->ID_DEPARTAMENTO-1]->TITULO_DEPARTAMENTO ?><br>
