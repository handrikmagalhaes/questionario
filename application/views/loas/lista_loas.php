...
-->
    <main class="container mt-5 pt-5">
        <div class="row mb-4 align-items-center animate__animated animate__fadeIn">
            <div class="col-md-6">
                <h2 class="fw-bold mb-0">Listagem de Perícias LOAS</h2>
                <!--<p class="text-muted">Gerencie as solicitações do sistema</p>-->
            </div>
            <div class="col-md-6 text-md-end">
                <button class="btn btn-primary rounded-pill px-4 shadow" onclick="window.location.href='{url_base}loas/cadastro'">
                    <i class="fa-solid fa-plus me-2"></i>Nova perícia LOAS
                </button>
            </div>
        </div>
        ...
        <div class="card table-card border-0 shadow-sm animate__animated animate__fadeInUp animate__delay-1s">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="tblLoas">
                    <thead>
                        <tr>
