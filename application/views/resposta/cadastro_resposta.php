...
<div class="modal" tabindex="-1" role="dialog" id="modal-foto-perfil">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"onclick="history.go(-1)">Voltar</button>
      </div>
    </div>
  </div>
</div>
...
<!-- MODAL ALTERAR SENHA -->
<div id="modal-alterar-senha" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
