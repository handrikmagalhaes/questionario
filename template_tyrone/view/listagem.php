...
<body>
    ...
    <main class="container mt-5 pt-5">
        <div class="row mb-4 align-items-center animate__animated animate__fadeIn">
            <div class="col-md-6">
                <h2 class="fw-bold mb-0">Listagem de Processos</h2>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0" placeholder="Buscar por nome ou número do processo...">
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>12/05/2024</td>
                            <td><code class="text-dark">23041.002145/2024-12</code></td>
                            <td><span class="badge rounded-pill badge-sipejud px-3 py-2">SIRPEJUD</span></td>
                        ...
                        <tr>
                            ...
                            <td>10/05/2024</td>
                            <td><code class="text-dark">23041.999999/2024-99</code></td>
                            <td><span class="badge rounded-pill badge-loas px-3 py-2">LOAS</span></td>
                            <td class="text-center">
                                <button class="btn btn-light btn-sm rounded-circle me-1"><i class="fa-solid fa-eye text-primary"></i></button>
                                <button class="btn btn-light btn-sm rounded-circle"><i class="fa-solid fa-pen-to-square text-muted"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
